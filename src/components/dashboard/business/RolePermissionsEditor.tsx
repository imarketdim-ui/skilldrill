...
const permissions: PermissionItem[] = [
  ...
  { key: 'bookings:bulk_manage', label: 'Массовые операции', description: 'Групповое подтверждение, завершение и отмена записей', group: 'crm' },
  { key: 'bookings:export', label: 'Экспорт журнала', description: 'Выгрузка журнала в CSV и ICS', group: 'crm' },
  ...
  { key: 'schedule:view_team', label: 'Командный журнал', description: 'Просмотр общего журнала по всем мастерам', group: 'crm' },
  ...
  { key: 'clients:rating_view', label: 'Рейтинг клиента', description: 'Просмотр клиентского рейтинга и риск-статуса', group: 'crm' },
  ...
  { key: 'resources:view', label: 'Просмотр ресурсов', description: 'Кабинеты, залы и оборудование', group: 'erp' },
  { key: 'resources:manage', label: 'Управление ресурсами', description: 'Создание и настройка ресурсов', group: 'erp' },
  ...
  { key: 'reports:view', label: 'Просмотр отчётов', description: 'Операционные и ERP-отчёты', group: 'erp' },
...
const defaultPermissions: Record<string, string[]> = {
  ...
  manager: [
    'bookings:view', 'bookings:manage', 'bookings:bulk_manage', 'bookings:export', 'schedule:view', 'schedule:manage', 'schedule:view_team',
    'clients:view', 'clients:manage', 'clients:rating_view', 'chats:view',
    'marketing:view', 'marketing:manage',
    'stats:view', 'services:view', 'services:manage',
    'team:view', 'resources:view', 'inventory:view', 'inventory:manage', 'reports:view',
  ...
  business_admin: [
    ...
    'marketing:view', 'marketing:manage',
    'stats:view', 'services:view', 'services:manage',
    'team:view', 'team:manage', 'resources:view', 'resources:manage', 'inventory:view', 'inventory:manage', 'reports:view',
    'promotions:view', 'promotions:manage',
