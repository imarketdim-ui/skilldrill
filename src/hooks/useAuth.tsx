...
export type UserRoleType = 'client' | 'master' | 'business_manager' | 'network_manager' | 'business_owner' | 'network_owner' | 'platform_admin' | 'super_admin' | 'platform_manager' | 'moderator' | 'support' | 'integrator';
