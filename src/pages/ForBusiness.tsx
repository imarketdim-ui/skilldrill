...
const businessFeatures = [
  ...
  { icon: BarChart3, title: 'CRM + ERP (бета)', description: 'Технологические карты услуг, расчёт себестоимости, учёт расходников. Функционал в стадии бета-тестирования.' },
  ...
  const plans = [
    {
      ...
      features: ['Личное расписание и клиенты', 'Профиль с фото и адресом', 'CRM и базовая аналитика', '14 дней бесплатно'],
      link: '/create-account?type=master',
    },
    {
      name: 'Про',
      price: pricing.business.toLocaleString(),
      description: 'Для бизнеса с одной точкой',
      popular: true,
      features: ['1 точка, до 10 сотрудников', 'CRM + ERP + Касса + Склад', 'Закупки, списания, зарплаты', 'Бонусные программы и сертификаты'],
      link: '/create-account?type=business',
    },
    {
      name: 'Сеть',
      price: pricing.network.toLocaleString(),
      description: 'Для сетей с несколькими точками',
      features: ['Неограниченно точек и сотрудников', 'Единый дашборд по сети', 'Сквозная аналитика и маркетинг', 'Централизованная CRM'],
