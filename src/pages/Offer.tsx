        ...
        <div className="container-wide max-w-4xl mx-auto">
          ...
          <div className="prose prose-neutral max-w-none space-y-6">
            ...
            <section className="space-y-3">
              ...
              <p>Оплата производится ежемесячно банковской картой через систему интернет-эквайринга АО «Тинькофф Банк».</p>
              <p>Рекуррентные платежи: при подключении автоплатежа списание происходит автоматически в дату продления подписки.</p>
            </section>
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-semibold">8. Реквизиты Оператора</h2>
