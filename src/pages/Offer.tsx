          ...
          <div className="prose prose-neutral max-w-none space-y-6">
            ...
            <section className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Мастер: 1 000 ₽/мес (пробный период — 14 дней бесплатно)</li>
                <li>Бизнес: 3 000 ₽/мес (до 5 мастеров), +500 ₽/мес за дополнительного мастера</li>
                <li>Сеть: 3 000 ₽/мес (до 3 точек), +1 000 ₽/мес за доп. точку</li>
              </ul>
