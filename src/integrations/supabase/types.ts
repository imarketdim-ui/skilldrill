    ...
    Tables: {
      ...
      business_locations: {
        Row: {
          ...
          owner_id: string
          priority_for_user_id: string | null
      ...
      loyalty_memberships: {
        ...
        Relationships: [
          {
            foreignKeyName: "loyalty_memberships_program_id_fkey"
            columns: ["program_id"]
            isOneToOne: false
      ...
      master_achievements: {
        ...
        Relationships: [
          {
            foreignKeyName: "master_achievements_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      salary_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "salary_records_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "business_locations"
            referencedColumns: ["id"]
      ...
      salary_schemes: {
        ...
        Relationships: [
          {
            foreignKeyName: "salary_schemes_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "business_locations"
            referencedColumns: ["id"]
